CREATE TABLE IF NOT EXISTS `given_questions` (
  ...
  `sender_id`  varchar(20) NOT NULL                             COMMENT 'Discord user ID of the person giving the question',
  `target_id`  varchar(20) NOT NULL                             COMMENT 'Discord user ID of the person receiving the question',
  `server_id`  varchar(20) NOT NULL                             COMMENT 'Discord server ID where question was given',
  `message_id` varchar(20) DEFAULT NULL                         COMMENT 'Discord message ID of the question',
  ...
  `done_count` int NOT NULL DEFAULT '0'                         COMMENT 'Number of completion votes',
  `fail_count` int NOT NULL DEFAULT '0'                         COMMENT 'Number of failure votes',
  ...
  `xp_type`    varchar(10) NOT NULL DEFAULT 'global'            COMMENT 'Where XP is awarded: "global" or "server"',
  PRIMARY KEY (`id`),
