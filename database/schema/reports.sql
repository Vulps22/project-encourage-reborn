CREATE TABLE IF NOT EXISTS `reports` (
  ...
  `moderatorId` varchar(20) DEFAULT NULL                                                     COMMENT 'Discord user ID of moderator handling the report',
  `banReason`   text                                                                         COMMENT 'Moderator-provided reason if content was banned',
  `senderId`    varchar(20) NOT NULL                                                         COMMENT 'Discord user ID who submitted the report',
  `offenderId`  varchar(20) NOT NULL                                                         COMMENT 'Discord user ID of the reported user',
  `serverId`    varchar(20) NOT NULL                                                         COMMENT 'Discord server ID where report occurred',
