CREATE TABLE IF NOT EXISTS `servers` (
  ...
  `has_accepted`         tinyint(1) NOT NULL DEFAULT '0'                                         COMMENT 'Whether owner has accepted bot terms/rules',
  `is_banned`            tinyint(1) NOT NULL DEFAULT '0'                                         COMMENT 'Whether server is banned from using the bot',
  `ban_reason`           text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci                   COMMENT 'Reason for server ban',
  ...
  `is_deleted`           tinyint NOT NULL DEFAULT '0'                                            COMMENT 'Whether server has been soft deleted',
