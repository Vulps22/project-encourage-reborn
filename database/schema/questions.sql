CREATE TABLE IF NOT EXISTS `questions` (
  ...
  `isApproved`        tinyint NOT NULL DEFAULT '0',                    COMMENT 'Whether question has been approved by moderators',
  `approvedBy`        varchar(20) NOT NULL DEFAULT 'pre-v5-6',         COMMENT 'Discord user ID of the moderator who approved',
  `datetime_approved` datetime DEFAULT NULL,                           COMMENT 'When the question was approved (set by trigger)',
  `isBanned`          tinyint NOT NULL DEFAULT '0',                    COMMENT 'Whether question has been banned',
  `banReason`         text,                                            COMMENT 'Reason for banning the question',
  `bannedBy`          varchar(20) DEFAULT NULL,                        COMMENT 'Discord user ID of the moderator who banned',
  ...
  `serverId`          varchar(20) NOT NULL DEFAULT 'pre-v5',           COMMENT 'Discord server ID where question was submitted',
  `messageId`         varchar(20) DEFAULT 'pre-v5',                    COMMENT 'Discord message ID of the submission',
  `isDeleted`         tinyint NOT NULL DEFAULT '0',                    COMMENT 'Whether question has been soft deleted',
