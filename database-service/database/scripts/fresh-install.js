...
async function freshInstall() {
  ...
  try {
    ...
    console.log(`Connecting to ${process.env.DB_HOST}:${process.env.DB_PORT || 5432} as ${process.env.DB_USER} on database "${process.env.DB_NAME}"...`);
    ...
    if (process.env.NODE_ENV === 'development') {
      ...
      await client.query(`
        INSERT INTO "server"."servers" (
          ...
          1079206786021732412, 'Truth Or Dare Online 18+', 914368203482890240, true, true, false,
      ...
      `);
      await client.query(`UPDATE "core"."config" SET "vote_threshold" = 1 WHERE "id" = 'config';`);
