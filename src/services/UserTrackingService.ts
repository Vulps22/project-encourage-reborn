...
export class UserTrackingService {
   ...
   * 
   * This method:
   * - Rejects DM interactions (throws DMInteractionError)
   * - Checks cache to avoid redundant database calls
   * - Ensures user exists in database
   * - Ensures server exists in database
   * - Ensures user-server relationship exists
